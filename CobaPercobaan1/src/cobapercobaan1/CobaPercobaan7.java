...
public class CobaPercobaan7 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nIF..ELSE..");
        if(a>5){
            System.out.println("isi bariabel a : " + a);
       ...
       System.out.println("\nIF..ELSE IF..ELSE..1");
        ...
        System.out.println("\nIF..ELSE IF..ELSE.. 2");
        if(a < 2){
            System.out.println("nilsi a kurang dari 2");
        } else if (a < 4){
            System.out.println("nili a kurang dari 4");
        } else if (a < 6){
        ...
        if (a < 7) { 
            ...
            if (a > 2)
                System.out.println("nilai a kurang dari ?");
            if (a < 4)
        ...
        switch (a) {
            ...
            default: System.out.println("nilai a bukan anatara 1-5");
